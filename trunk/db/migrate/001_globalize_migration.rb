...
class GlobalizeMigration < ActiveRecord::Migration
  ...
  def self.up
    set_version('001')
    log('Globalization Structure')
    log('Warning: Can take up to 10 minutes!')
    ...
    # add in defaults
    log('Globalization Data[1/3]: Countries')
    load_from_csv("globalize_countries", country_data)
    
    log('Globalization Data[2/3]: Languages')
    load_from_csv("globalize_languages", language_data)
    
    log('Globalization Data[3/3]: Translations')
    load_from_csv("globalize_translations", translation_data)
  end

  def self.down
    set_version('001')
    log('Globalization Structure Teardown')
