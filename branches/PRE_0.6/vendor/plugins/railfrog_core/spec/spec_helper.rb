...
@@__plugin_system_root = File.join(RAILS_ROOT, 'vendor', 'plugins', 'railfrog_core', 'spec', 'lib', 'plugin_system', 'data')
...
@@__no_plugins_root = File.join(RAILS_ROOT, 'vendor', 'plugins', 'railfrog_core', 'spec', 'lib', 'plugin_system', 'no_plugins')
