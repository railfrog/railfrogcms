...
class ViewTranslationTest < Test::Unit::TestCase
  ...
  def test_set_translation_pl
    ...
    Locale.set("he-IL")
    Locale.set_translation("%d dark and stormy nights", "ליל קודר וגועש", "%d לילות קודרים וגועשים" )
  ...
  def test_cache
    ...
    # test for purging
    tr.max_cache_size = 41 / 1024  # in bytes
    assert_equal "יש לי 5 קבצים", "I have %d files" / 5    
    assert_equal 1, tr.cache_count
