...
=end  
  class Locale
    ...
    #
    # WARNING: do not call this method in environment.rb as it will prevent the
    # application's environment from initializing if the Globalize tables are not
    # yet loaded.
    ...
    def self.set_translation(key, *options)
      ...
      translations = options.flatten.compact
      translator.set(key, language, translations)
    end
